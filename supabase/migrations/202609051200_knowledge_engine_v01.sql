-- ファミーユ Knowledge Engine v0.1 基盤。原本全文やOAuth token平文は保存しない。
...
-- 初期sourceは安全のため無効で登録する。Dry Run確認後に管理画面から有効化する。
insert into public.knowledge_sources (
  source_key, source_type, connector_key, name, description, source_url,
  enabled, sync_frequency, schedule, default_category,
  default_privacy_level, default_publishability, config
) values
  (
    'kusano-thought-log', 'conversation', 'google_sheets', '草野思考ログ',
    '草野思考ナレッジDBの思考ログ', 'https://docs.google.com/spreadsheets/d/1-uWKp4OTYdotXyWSm-P-yJOmnGd3epdg7_0oy3yr3mA/edit',
    false, 'daily', '{"time":"06:30"}'::jsonb, '草野思考',
    1, 'internal_only',
  ...
  (
    'external-rss', 'rss', 'google_sheets', 'RSS・外部情報',
    '草野思考ナレッジDBのRSS管理シート', 'https://docs.google.com/spreadsheets/d/1-uWKp4OTYdotXyWSm-P-yJOmnGd3epdg7_0oy3yr3mA/edit?gid=24681012',
    false, 'hourly', '{}'::jsonb, '外部情報',
    0, 'public',
    '{"spreadsheetId":"1-uWKp4OTYdotXyWSm-P-yJOmnGd3epdg7_0oy3yr3mA","sheets":[{"name":"RSS","headerRow":1}],"mode":"rss_index","maxRows":5000}'::jsonb
  ),
  (
    'lesson-reminders', 'lesson_reminder', 'google_sheets', '教訓リマインド',
    'ヘルパー・管理者・総務・採用向け教訓', 'https://docs.google.com/spreadsheets/d/1qlPIJXZikm_M4beGY_DxQYxAJHfdwUcLCP9YcA72QP4/edit',
    false, 'daily', '{"time":"06:30"}'::jsonb, '業務教訓',
    3, 'never_publish',
    '{"spreadsheetId":"1qlPIJXZikm_M4beGY_DxQYxAJHfdwUcLCP9YcA72QP4","sheets":[{"name":"Forヘルパー","headerRow":3},{"name":"For全マネジャー","headerRow":1},{"name":"Forマネジャー","headerRow":1},{"name":"総務チームリマインド","headerRow":1},{"name":"採用担当リマインド","headerRow":1}],"mode":"lesson_index","maxRows":3000}'::jsonb
  ),
  (
    'billing-management', 'billing', 'google_sheets', '請求管理表',
    '月次提供実績・請求・売上推移', 'https://docs.google.com/spreadsheets/d/1hsCfwgIXWkkLrK9mXhQyNLsiy8kGgwmwjlylzjXqfPY/edit',
    false, 'monthly', '{"day":2,"time":"07:00"}'::jsonb, '経営・財務',
    2, 'internal_only',
    '{"spreadsheetId":"1hsCfwgIXWkkLrK9mXhQyNLsiy8kGgwmwjlylzjXqfPY","sheets":[{"name":"請求管理表","headerRow":1}],"mode":"billing_metrics","maxRows":1500}'::jsonb
  ),
  (
    'github-myfamille', 'github', 'github', 'GitHub: MyFamille',
    'MyFamille本体の構成・変更・設計判断', 'https://github.com/junkusano/famille_shift_matching',
    false, 'hourly', '{}'::jsonb, 'システム設計',
    2, 'internal_only',
    '{"repository":"junkusano/famille_shift_matching","branch":"master"}'::jsonb
  ),
  (
    'github-famille-rpa', 'github', 'github', 'GitHub: famille-rpa',
    'ブラウザRPAの構成・変更・設計判断', 'https://github.com/junkusano/famille-rpa',
    false, 'hourly', '{}'::jsonb, 'システム設計',
    2, 'internal_only',
    '{"repository":"junkusano/famille-rpa","branch":"main"}'::jsonb
  ),
  (
    'github-famille-rpa-runner', 'github', 'github', 'GitHub: famille-rpa-runner',
    'RPA Runnerの構成・変更・設計判断', 'https://github.com/junkusano/famille-rpa-runner',
    false, 'hourly', '{}'::jsonb, 'システム設計',
    2, 'internal_only',
    '{"repository":"junkusano/famille-rpa-runner","branch":"main"}'::jsonb
  ),
  (
    'fax-cs-docs', 'fax', 'fax', '外部受信FAX',
    'cs_docsとFAX関連テーブルの内部限定索引', '/portal/cs_docs',
    false, 'daily', '{"time":"06:15"}'::jsonb, 'FAX',
    3, 'never_publish',
    '{"mode":"metadata_only"}'::jsonb
  ),
  (
    'moneyforward-accounting', 'moneyforward', 'moneyforward', 'Money Forwardクラウド会計',
    'OAuth接続と月次財務指標', null,
    false, 'manual', '{}'::jsonb, '経営・財務',
    2, 'internal_only',
    '{"mode":"tenant_check_only"}'::jsonb
  )

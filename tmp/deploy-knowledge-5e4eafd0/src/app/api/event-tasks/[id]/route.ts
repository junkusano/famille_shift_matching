...
type EventTaskUpdate = Partial<{
    ...
    due_date: string;
    memo: string | null;
    status: "open" | "in_progress" | "done" | "cancelled" | "muted";
...
function getParams(context: unknown): RouteParams {
  if (typeof context !== "object" || context === null) throw new Error("Invalid route context");
  const c = context as { params?: unknown };
  if (typeof c.params !== "object" || c.params === null) throw new Error("Missing params");

...
const cmGetBreadcrumbs = (pathname: string): CmBreadcrumb[] => {
  const pathMap: Record<string, string> = {
    ...
    '/cm-portal/hr-labor/salary-slip': '給与明細',
    '/cm-portal/hr-labor/health-check-results': '健康診断結果',
    '/cm-portal/hr-labor/monthly-meeting-check': '月例会議参加チェック',
    '/cm-portal/hr-labor/bento': 'お弁当アンケート',
    ...
    '/cm-portal/master/contract-templates': '契約書テンプレート',
  };

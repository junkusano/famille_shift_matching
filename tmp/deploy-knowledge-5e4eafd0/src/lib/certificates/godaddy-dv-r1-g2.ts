/*
 * Public GoDaddy DV R1 certificate chain downloaded from:
 * https://certs.godaddy.com/repository/gd_bundle_dv-r1-g2.crt.pem
 *
 * ABBYY's Cloud OCR endpoint currently sends only its leaf certificate. This
 * chain is added only to ABBYY requests while keeping TLS verification enabled.
 */
export const GODADDY_DV_R1_G2_CERTIFICATE_CHAIN = `-----BEGIN CERTIFICATE-----

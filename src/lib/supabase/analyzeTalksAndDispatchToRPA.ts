...
function firstStaffOf(row: any): string | null {
  return row?.staff_01_user_id || row?.staff_02_user_id || row?.staff_03_user_id || null;
}
...
function pickByDaypart(rows: any[], k: keyof typeof DAYPART): any | null {

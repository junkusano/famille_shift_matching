// =============================================================
// src/lib/cm/rpa-jobs/core.ts
// RPAジョブ管理 コアロジック（認証なし・純粋なDB操作）
//
// Server Actions（actions.ts）と API Route の両方から呼ばれる。
// 認証は呼び出し元の責務。このファイルには認証処理を含めない。
// =============================================================
...
const logger = createLogger("lib/cm/rpa-jobs/core");
...
// =============================================================
// cmGetJobMasterCore - マスタ取得
// =============================================================

export async function cmGetJobMasterCore(queueCode?: string): Promise<GetJobMasterResult> {
  try {
...
// =============================================================
// cmGetJobsCore - ジョブ一覧取得
// =============================================================

export async function cmGetJobsCore(params: GetJobsParams = {}): Promise<GetJobsResult> {
  try {
    const {
      queue,
      status,
...
// =============================================================
// cmGetJobDetailCore - ジョブ詳細取得
// =============================================================

export async function cmGetJobDetailCore(jobId: number): Promise<GetJobDetailResult> {
  try {
...
// =============================================================
// cmCreateJobCore - ジョブ作成
// =============================================================

export async function cmCreateJobCore(params: CreateJobParams): Promise<CreateJobResult> {
  try {
...
// =============================================================
// cmUpdateJobCore - ジョブ更新
// =============================================================

export async function cmUpdateJobCore(
  jobId: number,

...
import {
  CM_OP_LOG_PHONEBOOK_CREATE,
  CM_OP_LOG_PHONEBOOK_UPDATE,
  CM_OP_LOG_PHONEBOOK_DELETE,
  CM_OP_LOG_PHONEBOOK_SYNC,
...
export async function createLocalFaxPhonebookEntry(
  ...
  try {
    ...
    return withAuditLog(
      {
        auth,
        action: CM_OP_LOG_PHONEBOOK_CREATE,
        resourceType: "phonebook",
        metadata: { name: data.name, fax_number: data.fax_number },
      },
      async () => {
...
export async function updateLocalFaxPhonebookEntry(
  ...
  try {
    ...
    return withAuditLog(
      {
        auth,
        action: CM_OP_LOG_PHONEBOOK_UPDATE,
        resourceType: "phonebook",
...
export async function deleteLocalFaxPhonebookEntry(
  ...
  try {
    ...
    return withAuditLog(
      {
        auth,
        action: CM_OP_LOG_PHONEBOOK_DELETE,
        resourceType: "phonebook",
        resourceId: String(id),
      },
      async () => {
...
export async function syncLocalFaxPhonebookWithXml(
  ...
  try {
    ...
    return withAuditLog(
      {
        auth,
        action: CM_OP_LOG_PHONEBOOK_SYNC,
        resourceType: "phonebook",
      },
      async () => {

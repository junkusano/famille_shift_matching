                  ...
                  <tr key={r.id} className="hover:bg-gray-50">
                    <td className="border-b p-2">
                      ...
                      <div className="mt-1 text-[11px] text-gray-500">
                        null/空はOK（値がある時だけユニーク）
                      </div>
                    </td>

                    <td className="border-b p-2">
                      <div className="font-semibold">{r.cs_kaipoke_info?.name ?? "-"}</div>
                      <div className="text-[11px] text-gray-500">{r.kaipoke_cs_id}</div>
                    </td>

                    <td className="border-b p-2">
                      <div className="text-gray-800">{r.cs_kaipoke_info?.address ?? "-"}</div>
                    </td>
                    ...
                    <td className="border-b p-2">
                      <button
                        className={`rounded-md px-2 py-1 text-xs font-semibold ${
                          permitNeed ? "bg-red-600 text-white" : "border hover:bg-gray-50"
                        }`}
                    ...
                    <td className="border-b p-2">
                      <button
                        className={`w-full rounded-md px-3 py-2 text-sm ${
                          dirty ? "bg-blue-600 text-white hover:opacity-90" : "border text-gray-500"
                        }`}

...
type CalendarPrintStyle = CSSProperties & {
...
export default function ShiftViewBetaPage() {
  ...
  const calendarPrintStyle: CalendarPrintStyle | undefined = calendarLayout.canBalance

...
const managerMenuGroups: MenuGroup[] = [
  ...
  { label: "シフト管理", icon: "📅", items: [{ label: "サービスコード管理", href: "/portal/shift-service-code" }, { label: "訪問記録定義", href: "/portal/shift-record-def" }, { label: "週間シフト", href: "/portal/roster/weekly" }, { label: "月間シフト", href: "/portal/roster/monthly" }, { label: "祝日シフト確認", href: "/portal/roster/holiday-shifts" }, { label: "シフト表", href: "/portal/roster/daily" }, { label: "シフトWish", href: "/portal/shift-wish" }, { label: "シフト・勤務一覧", href: "/portal/shift-view", secondary: { label: "β版", href: "/portal/shift-view-beta", beta: true } }, { label: "シフト・訪問記録", href: "/portal/shift" }, { label: "実績記録チェック", href: "/portal/disability-check" }] },
...
const commonMenuGroups = (currentYm: string): MenuGroup[] => [
  ...
  { label: "シフト", icon: "🕒", items: [{ label: "シフト・勤務一覧", href: "/portal/shift-view", secondary: { label: "β版", href: "/portal/shift-view-beta", beta: true } }, { label: "シフト・訪問記録", href: "/portal/shift" }, { label: "シフトセルフコーディネート（シフ子）", href: "/portal/shift-coordinate" }, { label: "実績記録チェック", href: "/portal/disability-check" }] },
];
...
export default function PortalLayout({ children }: Props) {
  ...
  // The released mobile menu is enabled for every device.

...
const managerMenuGroups: MenuGroup[] = [
  ...
  { label: "シフト管理", icon: "📅", items: [{ label: "サービスコード管理", href: "/portal/shift-service-code" }, { label: "訪問記録定義", href: "/portal/shift-record-def" }, { label: "週間シフト", href: "/portal/roster/weekly" }, { label: "月間シフト", href: "/portal/roster/monthly" }, { label: "祝日シフト確認", href: "/portal/roster/holiday-shifts" }, { label: "シフト表", href: "/portal/roster/daily", secondary: { label: "β版", href: "/portal/roster/daily-beta", beta: true } }, { label: "シフトWish", href: "/portal/shift-wish" }, { label: "シフト・勤務一覧", href: "/portal/shift-view", secondary: { label: "β版", href: "/portal/shift-view-beta", beta: true } }, { label: "シフト・訪問記録", href: "/portal/shift" }, { label: "実績記録チェック", href: "/portal/disability-check", secondary: { label: "β版", href: "/portal/disability-check-beta", beta: true } }] },
...
const commonMenuGroups = (currentYm: string): MenuGroup[] => [
  ...
  { label: "シフト", icon: "🕒", items: [{ label: "シフト・勤務一覧", href: "/portal/shift-view", secondary: { label: "β版", href: "/portal/shift-view-beta", beta: true } }, { label: "シフト・訪問記録", href: "/portal/shift", secondary: { label: "β版", href: "/portal/shift-reject-performance-test", beta: true } }, { label: "シフトセルフコーディネート（シフ子）", href: "/portal/shift-coordinate", secondary: { label: "β版", href: "/portal/shift-coordinate-performance-test", beta: true } }, { label: "実績記録チェック", href: "/portal/disability-check", secondary: { label: "β版", href: "/portal/disability-check-beta", beta: true } }] },
];
    ...
    <ul className="mt-6 space-y-2">
      ...
      {isManagerOrAdmin && (
        <>
          ...
          <li><Link href="/portal/admin/monitoring-office-notice" className="text-blue-300 hover:underline">モニタリング管理</Link></li>
...
<li><Link href="/portal/rpa_temp/list" className="text-blue-300 hover:underline">RPAテンプレ管理</Link></li>
          ...
          <li><Link href="/portal/agent-playbooks" className="text-blue-300 hover:underline">スマートアイ業務ルール</Link></li>
...
function TreeMenu({ role, onUseLegacy }: { role: string | null; onUseLegacy: () => void }) {
  ...
  const currentYm = getCurrentYmJst();
  const managerFrequentItems: MenuItem[] = [{ label: "ダッシュボード", href: "/portal/dashboard" }, { label: "エントリー一覧", href: "/portal/entry-list" }, { label: "利用者情報", href: "/portal/kaipoke-info" }, { label: "シフト表", href: "/portal/roster/daily" }, { label: "シフト表 β版", href: "/portal/roster/daily-beta", beta: true }, { label: "月間シフト", href: "/portal/roster/monthly" }];

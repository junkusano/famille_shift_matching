...
- 原則として空文字にしてください。
- ケアプラン、担当者会議、アセスメント、訪問記録に、本人または家族が行う内容・役割・協力事項が明確に記載されている場合だけ生成してください。
- 「できることは本人にしてもらう」「家族に協力してもらう」等の一般論は禁止です。
- 明確な根拠がない場合は必ず空文字にしてください。
- 本人の残存能力を推測して役割を作らないでください。
...
【介護保険プランの場合】
- ケアプラン第2表に記載されたサービス内容、援助内容、留意事項を優先してください。
- 選択した基準ケアプランのOCR本文に具体的な支援内容がある場合は、サマリーよりOCR本文を優先してください。
- 訪問介護と関係しない通所介護、福祉用具、医療機関のみのサービス内容は混在させないでください。
- ただし、デイサービスへの送り出し、迎え入れ、外出準備、帰宅後確認等、訪問介護が担当する内容は反映してください。

...
// 追加: リクエストからトークン抽出（?token / x-cron-token / Authorization）
export function getIncomingCronToken(req: NextRequest): string | null {
...
export function assertCronAuth(req: NextRequest) {
    ...
    const clientToken = getIncomingCronToken(req);

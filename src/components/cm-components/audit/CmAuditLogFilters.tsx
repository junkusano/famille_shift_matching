// =============================================================
// src/components/cm-components/audit/CmAuditLogFilters.tsx
// システムログ検索フィルター
// =============================================================
...
import type { CmAuditLogFilters as CmAuditLogFiltersType } from '@/types/cm/auditLogs';

type Props = {
  filters: CmAuditLogFiltersType;
  onFilterChange: (key: keyof CmAuditLogFiltersType, value: string) => void;
  onSearch: () => void;
  onReset: () => void;
};

export function CmAuditLogFilters({
  filters,
  onFilterChange,
  onSearch,
  onReset,

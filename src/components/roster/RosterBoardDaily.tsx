...
{c.spot_status === "募集中" && (
    <div className="absolute top-1 right-2 z-20 flex h-4 w-4 items-center justify-center rounded-full border border-gray-300 bg-white text-[9px] font-bold text-gray-900 shadow">
        T
    </div>
)}

{c.spot_status === "確定" && (
    <div className="absolute top-1 right-2 z-20 flex h-4 w-4 items-center justify-center rounded-full bg-yellow-300 text-[9px] font-bold text-black shadow">
        T
    </div>
)}
